...
erpnext.SalesFunnel = class SalesFunnel {
	...
	get_data(btn) {
		...
		const method_map = {
			sales_funnel: "serverscript.serverscript.page.funnel.funnel.get_funnel_data",
			opp_by_lead_source: "serverscript.serverscript.page.funnel.funnel.get_funnel_data",
			sales_pipeline: "serverscript.serverscript.page.funnel.funnel.get_funnel_data",
		};
		frappe.call({
